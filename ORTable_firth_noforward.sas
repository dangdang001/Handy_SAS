*macro created on 04/07/2016 to do multivariable logistic regression without forward selectin and firth correction;
...
%macro oddstablenoff(in=,var=,sig=,z=,out=,dir=);
...
%if %symexist(sig) %then %let sig2= &z. &sig;
%else %let sig2= &z. ;
%put sig2;
